...
class DOH100DataLoader(BaseDataLoader):
    """
    100 DOH image dataloader
    """
...
class DOH100Dataset(Dataset):
    """
    100 DOH image dataset
    """

    def __init__(self,
                 priors,
                 img_root='/mnt/ssd/qichen/100doh/raw',
                 annotation_dir='/mnt/ssd/qichen/100doh/file',
                 mode='train',
                 inp_size=224,
                 bbox_area_thres=1,
                 bbox_w_thres=1,
